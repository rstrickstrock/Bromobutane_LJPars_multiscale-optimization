...
def make_energy_simdir(current_working_directory, simdir, pars):
  ...
  shutil.copy(os.path.join(energy_dir, "2-bromobutane-X_conformer_01.gro"), simdir)
  shutil.copy(os.path.join(energy_dir, "2-bromobutane-X_conformer_02.gro"), simdir)
  shutil.copy(os.path.join(energy_dir, "2-bromobutane-X_conformer_03.gro"), simdir)
  shutil.copy(os.path.join(energy_dir, "topol_2-bromobutane-X.top"), simdir)
