...
if datasetname == "1-Bromobutane":
  statisticsFiles = [f'Stats_PR_1-bromobutane_top{top}.csv', f'Stats_RFR_1-bromobutane_top{top}.csv', f'Stats_GPR_1-bromobutane_top{top}.csv', f'Stats_NNR_1-bromobutane_top{top}.csv']
elif datasetname == "2-Bromobutane":
  statisticsFiles = [f'Stats_PR_2-bromobutane_top{top}.csv', f'Stats_RFR_2-bromobutane_top{top}.csv', f'Stats_GPR_2-bromobutane_top{top}.csv', f'Stats_NNR_2-bromobutane_top{top}.csv']
else:
...
facecolors = ['#ff7f00', '#984ea3', '#4daf4a', '#377eb8']
minmaxvals = True
...
if minmaxvals:
  ...
  maxMAPE = 0.02
  xAxisTol = 0.001
  MAPETicks = [0.006, 0.008, 0.010, 0.012, 0.014, 0.016, 0.018, 0.02]
  MAPETickLabels = []
  ...
  maxR2 = 1.0
  yAxisTol = 0.001
  R2Ticks = [0.98, 0.985, 0.99, 0.995, 1.0]
  R2TickLabels = []
  for tick in R2Ticks:
    R2TickLabels.append(f'{tick:.3f}')
...
if saveOrShow == "show":
    plt.show()
if saveOrShow == "save":
    plt.savefig(f'MAPE-vs-R2_allInOne_zoom_{datasetname}_top{top}.png', dpi=figDPI)
