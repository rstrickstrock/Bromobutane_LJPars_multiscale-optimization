...
for thisRatio in testSizes:
  ...
  for rndInt in rndInts:
    ...
    for thisDegree in degrees:
      ...
      model = make_pipeline(PolynomialFeatures(degree=thisDegree), LinearRegression())  
      model.fit(X_train, Y_train)
      pickle.dump(model, open(f'trained_model_{thisRatio}_{rndInt}_deg{thisDegree}.sav', 'wb'))
