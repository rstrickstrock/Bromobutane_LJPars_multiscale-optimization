...
if saveOrShow == "save":
  if not allKernels:
    plt.savefig(f'MAPE-vs-R2_GPR_{datasetname}_n{len(thisDF)}.png', dpi=figDPI)
  else:
    plt.savefig(f'MAPE-vs-R2_GPR_allKernels_{datasetname}_n{len(thisDF)}.png', dpi=figDPI)
